async function viewDetail(id) {
    ...
    await callApi(url, {
        ...
        document.getElementById('detail-url').value = d?.url ?? '';
        document.getElementById('detail-platform').value = d?.platform ?? '';
        document.getElementById('detail-icon-img').src = d?.iconUrl ?? '';
