...
public interface HomeBestFoodRepository extends
        JpaRepository<HomeBestFoodEntity, UUID>,
        RevisionRepository<HomeBestFoodEntity, UUID, Integer> {
    @Query("""
        SELECT e FROM HomeBestFoodEntity e WHERE
    ...
    """)
    Page<HomeBestFoodEntity> filter(FilterPayload payload,
