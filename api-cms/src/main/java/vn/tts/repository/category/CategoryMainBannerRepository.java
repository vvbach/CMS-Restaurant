...
public interface CategoryMainBannerRepository extends
        ...
        RevisionRepository<CategoryMainBannerEntity, UUID, Integer> {
    @Query("""
            SELECT e FROM CategoryMainBannerEntity e WHERE
            ...
            """)
    Page<CategoryMainBannerEntity> filter(
    ...
    @Query("""
            ...
            """)
    List<CategoryMainBannerEntity> findAllByCategoryPageId(@Param("categoryPageId") UUID categoryPageId);
}
