...
public interface AboutCategoryRepository extends
        JpaRepository<AboutCategoryEntity, UUID>,
        RevisionRepository<AboutCategoryEntity, UUID, Integer> {
    @Query("""
            SELECT e FROM AboutCategoryEntity e WHERE
            ...
            """)
    Page<AboutCategoryEntity> filter(FilterPayload payload,
    ...
    @Query("""
            ...
            """)
    List<AboutCategoryEntity> findAllByCategoryPageId(UUID categoryPageId);
}
