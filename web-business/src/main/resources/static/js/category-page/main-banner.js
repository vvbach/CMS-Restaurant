async function loadCategoryMainBanner() {
    await callApi(`/v1/api/category-main-banner/${location.pathname.split("/")[2]}`, {
        method: 'GET',
...
document.addEventListener("DOMContentLoaded", loadCategoryMainBanner);
